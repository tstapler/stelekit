 ...
 * Using distinctvalue classes for page and block UUIDs makes swapping them a compile error.
 */
value class PageUuid(val value: String) {
 ...
 */
value class BlockUuid(val value: String) {
    override fun toString(): String = value
}
 ...
 */
value class PageName(val value: String) {
    override fun toString(): String = value
}
