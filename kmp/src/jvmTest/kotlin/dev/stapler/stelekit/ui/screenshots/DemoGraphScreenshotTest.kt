...
class DemoGraphScreenshotTest {
    ...
    private fun buildFixtures(): Triple<Page, List<Block>, String> {
        ...
        val blocks = listOf(
            ...
            Block(uuid = BlockUuid("demo-b003"), pageUuid = PageUuid(pageUuid), parentUuid = BlockUuid("demo-b002"), content = "Opened the app and added my first graph", level = 1, position = "a0", createdAt = now, updatedAt = now),
            Block(uuid = BlockUuid("demo-b004"), pageUuid = PageUuid(pageUuid), parentUuid = BlockUuid("demo-b002"), content = "Created a few test pages", level = 1, position = "a1", createdAt = now, updatedAt = now),
            ...
            Block(uuid = BlockUuid("demo-b006"), pageUuid = PageUuid(pageUuid), parentUuid = BlockUuid("demo-b005"), content = "Blocks are the primary unit of content", level = 1, position = "a0", createdAt = now, updatedAt = now),
            Block(uuid = BlockUuid("demo-b007"), pageUuid = PageUuid(pageUuid), parentUuid = BlockUuid("demo-b005"), content = "Everything auto-saves after 500ms", level = 1, position = "a1", createdAt = now, updatedAt = now),
            Block(uuid = BlockUuid("demo-b008"), pageUuid = PageUuid(pageUuid), parentUuid = BlockUuid("demo-b005"), content = "[[Welcome]] is the best starting point", level = 1, position = "a2", createdAt = now, updatedAt = now),
