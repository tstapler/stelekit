...
ORDER BY depth, parent_uuid, position"""),
        ...
        AuditQuery("selectUnloadedPagesBySection",
            "SELECT * FROM pages WHERE is_content_loaded = 0 AND section_id IN ('') ORDER BY uuid LIMIT 10 OFFSET 0"),
        ...
        AuditQuery("selectJournalPageByDateAndSection",
            "SELECT * FROM pages WHERE is_journal = 1 AND journal_date = '2024-01-01' AND section_id = '' LIMIT 1"),
