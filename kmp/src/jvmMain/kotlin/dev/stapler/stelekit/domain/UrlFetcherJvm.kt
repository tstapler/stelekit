...
/**
 * JVM implementation of [UrlFetcher] using Ktor OkHttp engine and Ksoup for HTML parsing.
 *
...
class UrlFetcherJvm(
    ...
    override suspend fun fetch(url: String): FetchResult {
        ...
        if (!url.startsWith("http://") && !url.startsWith("https://")) {
            // Scheme rejection — not a network error, not an HTTP error, use code 0 to signal
